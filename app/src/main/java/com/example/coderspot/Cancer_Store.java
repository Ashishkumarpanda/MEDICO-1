...
import com.example.coderspot.ui.main.Camcer;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.auth.FirebaseUser;
import com.google.firebase.database.DatabaseReference;
import com.google.firebase.database.FirebaseDatabase;

public class Cancer_Store extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cancer__store);
        patientName = findViewById(R.id.cancer_name);
        diseaseName = findViewById(R.id.disease_name);
        id = findViewById(R.id.cancer_id);
        button=findViewById(R.id.btn_cancer);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Cancer_Help user = new Cancer_Help(patient_Name, disease_Name, id_numnber);

                reference.child(id_numnber).setValue(user);

                Toast.makeText(Cancer_Store.this, "DETAILS SAVED", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Cancer_Store.this, Camcer.class));
            }}
        });

...
public class Dengue_Store extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dengue__store);
        patientName = findViewById(R.id.dengue_name);
        diseaseName = findViewById(R.id.disease_name);
        id = findViewById(R.id.dengue_id);
        button=findViewById(R.id.btn_dengue);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DengueHelp user = new DengueHelp(patient_Name, disease_Name, id_numnber);

                reference.child(id_numnber).setValue(user);

                Toast.makeText(Dengue_Store.this, "DETAILS SAVED", Toast.LENGTH_SHORT).show();

                startActivity(new Intent(Dengue_Store.this,Dengue.class));
            }}
        });

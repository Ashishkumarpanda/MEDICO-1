...
public class Constipation_Store extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_constipation__store);

        patientName = findViewById(R.id.constpation_name);
        diseaseName = findViewById(R.id.disease_name);
        id = findViewById(R.id.constipation_id);
        button=findViewById(R.id.btn_constipation);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ConstipationHelper user = new ConstipationHelper(patient_Name, disease_Name, id_numnber);

                reference.child(id_numnber).setValue(user);

                Toast.makeText(Constipation_Store.this, "DETAILS SAVED", Toast.LENGTH_SHORT).show();

                startActivity(new Intent(Constipation_Store.this,Constipation.class));
            }
        });
    }
}
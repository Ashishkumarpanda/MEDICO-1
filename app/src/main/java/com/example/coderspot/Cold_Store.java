...
public class Cold_Store extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cold__store);

        patientName = findViewById(R.id.cold_name);
        diseaseName = findViewById(R.id.disease_name);
        id = findViewById(R.id.cold_id);
        button=findViewById(R.id.btn_cold);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ColdHelp user = new ColdHelp(patient_Name, disease_Name, id_numnber);

                reference.child(id_numnber).setValue(user);

                Toast.makeText(Cold_Store.this, "DETAILS SAVED", Toast.LENGTH_SHORT).show();

                startActivity(new Intent(Cold_Store.this,Cold.class));
            }}
        });
    }
}
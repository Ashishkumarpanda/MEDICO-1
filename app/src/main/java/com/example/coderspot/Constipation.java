...
public class Constipation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview=findViewById(R.id.list_view5);
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(Constipation.this,android.R.layout.simple_list_item_1,arrayList);
        listview.setAdapter(arrayAdapter);

        fref.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                String value = snapshot.getValue(ConstipationHelper.class).toString();
                arrayList.add(value);

...
public class Hepatites_Store extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hepatites__store);
        patientName = findViewById(R.id.hepa_name);
        diseaseName = findViewById(R.id.disease_name);
        id = findViewById(R.id.hepa_id);
        button=findViewById(R.id.btn_hepa);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (patient_Name.isEmpty()) {
                    ...
                    HepatitesHelper user = new HepatitesHelper(patient_Name, disease_Name, id_numnber);

                    reference.child(id_numnber).setValue(user);

                    Toast.makeText(Hepatites_Store.this, "DETAILS SAVED", Toast.LENGTH_SHORT).show();

                    startActivity(new Intent(Hepatites_Store.this, Hepatites.class));
                }
            }
        });
    }
